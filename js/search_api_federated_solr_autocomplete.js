              ...
              if (results.response.docs.length >= 1) {
                ...
                limitedResults.forEach(function(item) {
                  ...
                  var $suggestionTemplate = `
                      <div role='option' tabindex='-1' class='js-autocomplete-suggestion' id='suggestion-${counter}'>
                        <a class='js-autocomplete-suggestion__link' href='${item.ss_url}'>${highlighted}</a>
