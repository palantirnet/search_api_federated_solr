...
class FederatedPagination extends React.Component {
  ...
  renderPage(page, currentPage, key) {
    ...
    return (
      <li className={cx("pager__item", (isCurrentPage ? 'is-active' : 'not-active'))} key={key}>
    ...
    return (
      <nav className="pager" role="navigation" aria-labelledby="pagination-heading">
        ...
        <ul className="pager__items">
          <li className={cx("pager__item", {"element-invisible": firstPageHidden})} key="start">
          ...
          <li className={cx("pager__item", {"element-invisible": prevPageHidden})} key="prev">
          ...
          <li className={cx("pager__item", {"element-invisible": nextPageHidden})} key="next">
          ...
          <li className={cx("pager__item", {"element-invisible": lastPageHidden})} key="end">
